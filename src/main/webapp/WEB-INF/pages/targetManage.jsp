...
<table id="dg" title="目标管理" class="easyui-datagrid" fitColumns="true"
    ...
    <tr>
        ...
        <th field="id" width="50" align="center" sortable="true">目标编号</th>
        <th field="username" width="100" align="center" sortable="true">目标名称</th>
        <th field="company" width="100" align="center" sortable="true">目标类型</th>
        <th field="securityname" width="50" align="center" sortable="true">紧急程度</th>
        <th field="securitypassward" width="100" align="center"  sortable="true">目标执行人</th>
        <%--				<th field="company" width="100" align="center" sortable="true">证券公司</th>--%>
        <th field="starttime" width="100" align="center" sortable="true">目标创建时间</th>
        <th field="company" width="100" align="center" sortable="true">目标创建者</th>
    ...
    <tr>
        <th field="cb" checkbox="true" align="center"></th>
        <th field="id" width="50" align="center" sortable="true">17</th>
        <th field="username" width="100" align="center" sortable="true">收入目标</th>
        <th field="company" width="100" align="center" sortable="true">月度目标</th>
        <th field="securityname" width="50" align="center" sortable="true">中</th>
        <th field="securitypassward" width="100" align="center"  sortable="true">小乔</th>
        <%--				<th field="company" width="100" align="center" sortable="true">证券公司</th>--%>
        <th field="starttime" width="100" align="center" sortable="true">2022-05-01 09：14：24</th>
    ...
    <tr>
        <th field="cb" checkbox="true" align="center"></th>
        <th field="id" width="50" align="center" sortable="true">19</th>
        <th field="username" width="100" align="center" sortable="true">支出目标</th>
        <th field="company" width="100" align="center" sortable="true">年度目标</th>
        <th field="securityname" width="50" align="center" sortable="true">紧急</th>
        <th field="securitypassward" width="100" align="center"  sortable="true">张三</th>
        <%--				<th field="company" width="100" align="center" sortable="true">证券公司</th>--%>
        <th field="starttime" width="100" align="center" sortable="true">2022-05-17 09：14：24</th>
        <th field="company" width="100" align="center" sortable="true">1771404334xk</th>
        <%--				<!-- <th field="createtime" width="100" align="center" sortable="true">创建时间</th>--%>
        <%--				<th field="updatetime" width="100" align="center" sortable="true">修改时间</th> -->--%>
    </tr>
...
<div id="tb">
    ...
    <div>
        &nbsp;目标执行者：&nbsp;<input type="text" id="s_username" size="12" onkeydown="if(event.keyCode==13) searchSecurity()" />
        &nbsp;目标创建者：&nbsp;<input type="text" id="s_company" size="12" onkeydown="if(event.keyCode==13) searchSecurity()" />
        &nbsp;目标类型：&nbsp;<select class="easyui-combobox" id="s_dataid" editable="false" style="width: 100px;">
        <option value="">请选择...</option>
        <c:forEach items="${securitys }" var="security">
            <option value="${security.id }">${security.datadicvalue }</option>
        </c:forEach>
    </select>&nbsp;
        &nbsp;目标创建时间：&nbsp;<input type="text" id="s_searchStarttime" class="easyui-datetimebox" size="18" onkeydown="if(event.keyCode==13) searchSecurity()"/>
