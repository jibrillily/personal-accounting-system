...
public class DatabaseController {
	...
	public String delete(@RequestParam(value = "ids") String ids, ServletResponse response) throws Exception {
		...
		ResponseUtil.write(response1, result);
		return null;
	}
	...
	public String list(@RequestParam(value = "dataid", required = true) Integer dataid,
			...
			@RequestParam(value = "rows", required = false) String rows, Database s_databack, ServletResponse response)
			throws Exception {
